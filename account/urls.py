...
urlpatterns = [
    ...
    path(
        ...
        auth_views.PasswordResetConfirmView.as_view(
            ...
            success_url="/account/password_reset_confirm/password_reset_complete/",
    ...
    path(
        ...
        TemplateView.as_view(template_name="account/password_reset/reset_password_success_status.html"),
        name="password_reset_complete",
    ),
